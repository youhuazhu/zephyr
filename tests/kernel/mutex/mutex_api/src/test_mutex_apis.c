...
/**
 * @brief Test for the Mutex kernel object
 * @details To test the all the function and mechnism for mutex, it contains
 * below several test cases.
...
/**
 * @brief Test mutex initialization in build time
 * @details To verify a mutex can be defined and initialized at compile time,
 * this is the TESTPOINT of init via K_MUTEX_DEFINE.
...
/**
 * @brief Test mutex initialization and locking forever case
 * @details
 * - To verify a mutex can be defined and initialized at compile time or run
 *   time.
 * - To verify that getting a lock of a mutex already locked, waiters will be
 *   blocked forever.
 * @ingroup kernel_mutex_tests
 * @return should be PASS.
 */
...
/**
 * @brief Test mutex initialization and locking for no wait case
 * @details
 * - To verify a mutex can be defined and initialized at compile time or run
 *   time.
 * - To verify that getting a lock of a mutex already locked, waiters will not
 *   wait for it.
 * @ingroup kernel_mutex_tests
 * @return should be PASS.
 */
...
/**
 * @brief Test mutex initialization and locking for timeout failed case
 * @details
 * - To verify a mutex can be defined and initialized at compile time or run
 *   time.
 * - To verify that getting a lock of a mutex already locked, waiters will wait
 *   for a period of time and fail to get it.
 * @ingroup kernel_mutex_tests
 * @return should be PASS.
 */
...
/**
 * @brief Test mutex initialization and locking for timeout successful case
 * @details
 * - To verify a mutex can be defined and initialized at compile time or
 * run time.
 * - To verify that getting a lock of a mutex already locked will succeed and
 *   waiters will be unblocked only when the number of locks reaches zero.
 * @ingroup kernel_mutex_tests
 * @return should be PASS.
 */
...
/**
 * @brief Test mutex set amount of time the thread will wait
 * @details To verify the mutex lock operation shall accept a timeout parameter
 * indicating the maximum amount of time the thread will wait.
 * @ingroup kernel_mutex_tests
 * @return should be PASS.
 */
...
/**
 * @brief \b Test: recursive mutex
 * @details \b Describe: 
 * - To verify that getting a lock of a mutex already locked will
